...
class App {
  ...
  createRenderer() {
    ...
    console.log("Canvas created:", this.gl.canvas);
    console.log(
      "Canvas dimensions:",
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    ...
    console.log("Creating", this.mediasImages.length, "media items");
    this.medias = this.mediasImages.map((data, index) => {
      console.log("Creating media", index, "with image:", data.image);
      return new Media({
    ...
    console.log("All media items created");
  }
  onTouchDown(e) {
    this.isDown = true;
